					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class=<?php echo $manuName == 'project' ? "active" : ''; ?> ><a href="<?php echo $isInternal == true ? '../project/': 'project/';?>projectList.php"><i class="icon-home4"></i><span>Our Projects</span></a></li>
